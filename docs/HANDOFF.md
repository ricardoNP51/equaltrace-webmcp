...
Phase 1 guided build, the tagged release, and the Forensic Ledger redesign are complete. Checklist items 1–20 cover the broken-to-repaired winner chain, release hardening, exact public deployment, five-run native release proof, Devpost handoff, and video polish. Release `challenge-v1.0.0` is still deployed from commit `20ccacc499fcb8f7fed126f10af38e820c95b335` at `https://ricardonp51.github.io/equaltrace-webmcp/`; it does not yet contain the branch redesign. The submission draft is `devpost-submission.md`; the recording plan is `docs/DEMO_SCRIPT.md`; release screenshots are under `evidence/submission/`; native receipt ID is `3edf6503b77b0391a2fff20f31d664286a5db9c72d253ea6b0342db0aec44728`. The preferred local design candidate is the reproducible 1:20 Forensic Ledger cut at `submission-video/out/equaltrace-demo-forensic-ledger.mp4`; its audit is `docs/VIDEO_FORENSIC_LEDGER_AUDIT_2026-08-30.md`, its tracked capture inputs are under `submission-video/public/forensic-final/`, and its product visual QA is `design-qa.md`. The earlier Final Live, B3, V2, and original cuts remain reproducible comparison artifacts. Before this candidate replaces the public submission video, deploy the redesigned branch and perform a fresh public native recapture on that exact commit. Human audiovisual review, public upload, and actual submission remain human-confirmed external gates. Recreate root and video dependencies with `npm ci` in their respective directories; never copy `node_modules`, `.venv`, generated speech, model weights, or video renders.
