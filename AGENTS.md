...
1. Read `docs/STATUS.md`, `docs/WINNING_STANDARD.md`, and `docs/ARCHITECTURE.md`.
...
8. During documentation-only Phase 0, do not scaffold or implement the application unless the user explicitly starts Gate 1 on the next PC.
